    ...
    */
    foreach (int score in studentScores)
    {
        ...
        else
        {
            ...
            extraCreditAverage = (decimal) extraCreditScore / (gradedAssignments - examAssignments);
        }

        examAverage = (decimal) examScores / examAssignments;
    ...
    Console.WriteLine($"{currentStudent}\t\t{examAverage}\t\t{currentStudentGrade}\t\t{currentStudentLetterGrade}\t\t{extraCreditAverage} ({currentStudentGrade - examAverage}) pts");
}
